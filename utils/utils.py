    ...
    try:
        ...
        if not n:
            ...
            if Config.IS_LOOP:
                ...
                LOGGER.info("lofi hip hop radio")
                await start_stream()
            return False
        if Config.SHUFFLE:
    ...
    try:
        ...
        if who == 0:
            ...
            if Config.CPLAY:
                Config.CPLAY=False
                Config.STREAM_URL="https://www.youtube.com/watch?v=5qap5aO4i9A"
                LOGGER.warning("Seems like cplay is set as STARTUP_STREAM, Since nothing found on {chat.title}, switching to lofi hip hop radio as startup stream.")
        ...
        if Config.CPLAY:
            Config.CPLAY=False
            Config.STREAM_URL="https://www.youtube.com/watch?v=5qap5aO4i9A"
            LOGGER.warning("Seems like cplay is set as STARTUP_STREAM, and errors occured while getting playlist from given chat. Switching to lofi hip hop radio as default stream.")
            Config.STREAM_SETUP=False
        await sync_to_db()
